package com.github.mckelvym.vigiles.urbani.api;
...
public class CityNode {
	...
	public int distanceTo(CityNode destination) {
		return Math.abs(getX() - destination.getX()) + Math.abs(getY() - destination.getY());
	}
